...
For a local database, run `bun run db:up` (Docker), set `DATABASE_URL=postgresql://home:home@127.0.0.1:54320/home` in `apps/web/.env.local`, then run `bun run db:migrate`.
